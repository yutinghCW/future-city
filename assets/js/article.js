$(function(){
    ...
    $(window).on('scroll', function() {
        ...
        if ( isIE|isIE11 ) {
            if ( scorll <= (articleFootTop - height + 100 + 75 ) ) {
                $('.article__share').fadeIn();
            } else {
                $('.article__share').fadeOut();
            }
            if ( (scorll > (articleBodyTop + (articleBodyHeight/2) )) && (scorll <= (articleFootTop - height + 100 + 75 )) ) {
